...
describe('createRoute', () => {
  ...
  describe('Authentication', () => {
    ...
    it('should handle optional authentication', async () => {
      const handler = vi.fn().mockResolvedValue(
        new Response(JSON.stringify({ message: 'optional auth' }))
      );
    ...
    it('should skip auth when auth is false', async () => {
      const handler = vi.fn().mockResolvedValue(
        new Response(JSON.stringify({ message: 'no auth' }))
      );
  ...
  describe('Authorization', () => {
    it('should check authorization when provided', async () => {
      const handler = vi.fn().mockResolvedValue(
        new Response(JSON.stringify({ message: 'authorized' }))
      );
  ...
  describe('Query Parameter Validation', () => {
    it('should validate query parameters', async () => {
      ...
      const handler = vi.fn().mockResolvedValue(
        new Response(JSON.stringify({ message: 'query validated' }))
      );
  ...
  describe('Request Body Validation', () => {
    it('should validate POST request body', async () => {
      ...
      const handler = vi.fn().mockResolvedValue(
        new Response(JSON.stringify({ message: 'body validated' }))
      );
  ...
  describe('Path Parameter Validation', () => {
    it('should validate path parameters', async () => {
      ...
      const handler = vi.fn().mockResolvedValue(
        new Response(JSON.stringify({ message: 'params validated' }))
      );
